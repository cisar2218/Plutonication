...
namespace Substrate.NetApi.Generated.Storage
{
    ...
    public sealed class NominationPoolsStorage
    {
        ...
        public NominationPoolsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "GlobalMaxCommission"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "PoolMembers"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Generated.Model.pallet_nomination_pools.PoolMember)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "BondedPools"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "RewardPools"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApi.Generated.Model.pallet_nomination_pools.RewardPool)));
        ...
        /// </summary>
        public static string PoolMembersParams(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public static string ClaimPermissionsParams(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
    ...
    public sealed class NominationPoolsCalls
    {
        ...
        public static Method Join(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.NetApi.Model.Types.Primitive.U32 pool_id)
        {
            ...
            return new Method(19, "NominationPools", 0, "join", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method BondExtra(Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumBondExtra extra)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(extra.Encode());
            return new Method(19, "NominationPools", 1, "bond_extra", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(19, "NominationPools", 2, "claim_payout", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Unbond(Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress member_account, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> unbonding_points)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(member_account.Encode());
            byteArray.AddRange(unbonding_points.Encode());
            return new Method(19, "NominationPools", 3, "unbond", byteArray.ToArray());
        }
        ...
        public static Method PoolWithdrawUnbonded(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            ...
            return new Method(19, "NominationPools", 4, "pool_withdraw_unbonded", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method WithdrawUnbonded(Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress member_account, Substrate.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(member_account.Encode());
            byteArray.AddRange(num_slashing_spans.Encode());
            return new Method(19, "NominationPools", 5, "withdraw_unbonded", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Create(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress root, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress nominator, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress bouncer)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
            ...
            return new Method(19, "NominationPools", 6, "create", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateWithPoolId(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress root, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress nominator, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress bouncer, Substrate.NetApi.Model.Types.Primitive.U32 pool_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
            byteArray.AddRange(root.Encode());
            ...
            byteArray.AddRange(bouncer.Encode());
            byteArray.AddRange(pool_id.Encode());
            return new Method(19, "NominationPools", 7, "create_with_pool_id", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Nominate(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32> validators)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(validators.Encode());
            return new Method(19, "NominationPools", 8, "nominate", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetState(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumPoolState state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(state.Encode());
            return new Method(19, "NominationPools", 9, "set_state", byteArray.ToArray());
        }
        ...
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> metadata)
        {
            ...
            return new Method(19, "NominationPools", 10, "set_metadata", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetConfigs(Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_join_bond, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_create_bond, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_pools, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members_per_pool, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp global_max_commission)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(19, "NominationPools", 11, "set_configs", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateRoles(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_root, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_nominator, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_bouncer)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            ...
            return new Method(19, "NominationPools", 12, "update_roles", byteArray.ToArray());
        }
        ...
        public static Method Chill(Substrate.NetApi.Model.Types.Primitive.U32 pool_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            return new Method(19, "NominationPools", 13, "chill", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method BondExtraOther(Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress member, Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumBondExtra extra)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(member.Encode());
            byteArray.AddRange(extra.Encode());
            return new Method(19, "NominationPools", 14, "bond_extra_other", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetClaimPermission(Substrate.NetApi.Generated.Model.pallet_nomination_pools.EnumClaimPermission permission)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(permission.Encode());
            return new Method(19, "NominationPools", 15, "set_claim_permission", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ClaimPayoutOther(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 other)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(other.Encode());
            return new Method(19, "NominationPools", 16, "claim_payout_other", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetCommission(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill, Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32>> new_commission)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(new_commission.Encode());
            return new Method(19, "NominationPools", 17, "set_commission", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetCommissionMax(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill max_commission)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(max_commission.Encode());
            return new Method(19, "NominationPools", 18, "set_commission_max", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetCommissionChangeRate(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Generated.Model.pallet_nomination_pools.CommissionChangeRate change_rate)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(change_rate.Encode());
            return new Method(19, "NominationPools", 19, "set_commission_change_rate", byteArray.ToArray());
        }
    ...
    public sealed class NominationPoolsConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Generated.Model.frame_support.PalletId PalletId()
        {
