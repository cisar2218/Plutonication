...
namespace Substrate.NetApi.Generated.Storage
{
    ...
    public sealed class SchedulerStorage
    {
        ...
        ///  identities.
        /// </summary>
        public static string LookupParams(Substrate.NetApi.Generated.Types.Base.Arr32U8 key)
        {
    ...
    public sealed class SchedulerCalls
    {
        ...
        public static Method Schedule(Substrate.NetApi.Model.Types.Primitive.U32 when, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>> maybe_periodic, Substrate.NetApi.Model.Types.Primitive.U8 priority, Substrate.NetApi.Generated.Model.aleph_runtime.EnumRuntimeCall call)
        {
            ...
            return new Method(2, "Scheduler", 0, "schedule", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Substrate.NetApi.Model.Types.Primitive.U32 when, Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(2, "Scheduler", 1, "cancel", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ScheduleNamed(Substrate.NetApi.Generated.Types.Base.Arr32U8 id, Substrate.NetApi.Model.Types.Primitive.U32 when, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>> maybe_periodic, Substrate.NetApi.Model.Types.Primitive.U8 priority, Substrate.NetApi.Generated.Model.aleph_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            byteArray.AddRange(priority.Encode());
            byteArray.AddRange(call.Encode());
            return new Method(2, "Scheduler", 2, "schedule_named", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CancelNamed(Substrate.NetApi.Generated.Types.Base.Arr32U8 id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(id.Encode());
            return new Method(2, "Scheduler", 3, "cancel_named", byteArray.ToArray());
        }
        ...
        public static Method ScheduleAfter(Substrate.NetApi.Model.Types.Primitive.U32 after, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>> maybe_periodic, Substrate.NetApi.Model.Types.Primitive.U8 priority, Substrate.NetApi.Generated.Model.aleph_runtime.EnumRuntimeCall call)
        {
            ...
            byteArray.AddRange(priority.Encode());
            byteArray.AddRange(call.Encode());
            return new Method(2, "Scheduler", 4, "schedule_after", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ScheduleNamedAfter(Substrate.NetApi.Generated.Types.Base.Arr32U8 id, Substrate.NetApi.Model.Types.Primitive.U32 after, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>> maybe_periodic, Substrate.NetApi.Model.Types.Primitive.U8 priority, Substrate.NetApi.Generated.Model.aleph_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(id.Encode());
            byteArray.AddRange(after.Encode());
            ...
            byteArray.AddRange(priority.Encode());
            byteArray.AddRange(call.Encode());
            return new Method(2, "Scheduler", 5, "schedule_named_after", byteArray.ToArray());
        }
    }
    ...
    public sealed class SchedulerConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Generated.Model.sp_weights.weight_v2.Weight MaximumWeight()
        {
            var result = new Substrate.NetApi.Generated.Model.sp_weights.weight_v2.Weight();
            result.Create("0x0700807C814A13CCCCCCCCCCCCCCCC");
            return result;
        }
