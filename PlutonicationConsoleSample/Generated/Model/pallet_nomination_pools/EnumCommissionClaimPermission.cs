...
namespace Substrate.NetApi.Generated.Model.pallet_nomination_pools
{
    ...
    /// <summary>
    /// >> 69 - Variant[pallet_nomination_pools.CommissionClaimPermission]
    /// </summary>
    public sealed class EnumCommissionClaimPermission : BaseEnumRust<CommissionClaimPermission>
    {
        ...
        public EnumCommissionClaimPermission()
        {
				...
				AddTypeDecoder<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32>(CommissionClaimPermission.Account);
        }
    }
}
