...
namespace Substrate.NetApi.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Substrate.NetApi.Generated.Model.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Generated.Model.pallet_treasury.Proposal>(parameters, token);
            return result;
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13> Approvals(CancellationToken token)
        {
            string parameters = TreasuryStorage.ApprovalsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Spend(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
            byteArray.AddRange(beneficiary.Encode());
            return new Method(13, "Treasury", 3, "spend", byteArray.ToArray());
        }
